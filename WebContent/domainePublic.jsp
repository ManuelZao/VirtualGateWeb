...
<head>
<title>Virtual Gate | Pages | Domaine Public </title>
<meta charset="utf-8">
    ...
    <nav id="mainav" class="fl_right"> 
      ...
      <ul class="clear">
        ...
        <li class="active"><a class="drop" href="#">Mon Domaine</a>
          <ul>
            <li ><a href="domainePrive.jsp">Domaine Public</a></li>
            <li class="active"><a href="domainePublic.jsp">Domaine public</a></li>
