...
<head>
<title>Virtual Gate | Pages | Créer un compte </title>
<meta charset="utf-8">
  ...
  <div id="topbar" class="hoc clear">
    ...
    <div class="fl_right"> 
      ...
      <ul class="nospace">
        ...
        <li><a href="connexion.jsp" title="Connexion"><i class="fas fa-edit"></i></a></li>
        <li id="searchform">
          <div>
      ...
      <div id="comments">
        ...
        <form action="CreerCompteServlet" method="post">
          ...
          <div>
            ...
            <div class="one_half">
              <label for="nomFichier">Prénom</label>
              <input type="text" name="prenom" id="prenom" value="" size="22" required>
            </div>

            <div class="one_half first">
              <label for="nomFichier">Email</label>
            ...
            <div class="one_half first">
              <label for="nomFichier">Mot de passe</label>
