...
<head>
<title>Virtual Gate | Pages | Gallerie </title>
<meta charset="utf-8">
      ...
      <ul class="clear">
        ...
        <li class="active"><a class="drop" href="#">Mon Domaine</a>
          <ul>
            ...
            <li class="active"><a href="gallerie.jsp">Gallerie</a></li>
...
<div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/01.PNG');">
  <div id="breadcrumb" class="hoc clear"> 
    ...
    <ul>
      ...
      <li><a href="#">Gallerie - tous mes fichiers</a></li>
    </ul>
    <!-- ################################################################################################ -->
  </div>
</div>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      ...
      <div id="gallery">
        <figure>
          <header class="heading">Ma Gallerie - Tous mes fichiers</header>
